...
def sort_test(tested_sort, N, M, name):
    ...
    time_stop = time.time()
    print name, ":", "longest:", longest, "avg:", comp_sum / M, "sigma:", math.sqrt((M * comp_sqsum - comp_sum * comp_sum) / (M - 1)) / M, "time", time_stop - time_start
...
sort_test(miplzph_sort, N, M, "millzph")
